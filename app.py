...
<style>
    ...
    .stButton > button { width: 100%; border-radius: 6px; font-weight: bold !important; height: 45px; }
</style>
...
with tab_mag:
    ...
    if dati:
        ...
        scelta = st.selectbox("Seleziona prodotto da eliminare:", list(opzioni_del.keys()))
